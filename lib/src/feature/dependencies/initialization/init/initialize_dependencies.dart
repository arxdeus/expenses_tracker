...
@internal
mixin InitializeDependencies<MutableDependencies extends Object, Dependencies extends Object> {
  /// Initializes the app and returns a [Dependencies] object
  @protected
  Future<Dependencies> _$initializeDependencies({
    required Dependencies Function(MutableDependencies mutableDependencies) freeze,
