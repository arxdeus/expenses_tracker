...
typedef InitializationProgressRecord = ({int progress, String message});
typedef InitializationProgressListenable = ValueListenable<InitializationProgressRecord>;

abstract class InitializationExecutor<MutableDependencies extends Object, Dependencies extends Object>
    with ChangeNotifier, InitializeDependencies<MutableDependencies, Dependencies>
  ...
  @override
  InitializationProgressRecord get value => _value;
  InitializationProgressRecord _value = (progress: 0, message: '');
